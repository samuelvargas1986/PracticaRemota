...
MySQL - 10.4.17-MariaDB : Database - helpets
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`helpets` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
CREATE TABLE `adopciones` (
  ...
  UNIQUE KEY `uk_idmascota_adop` (`idpersona`,`idmascota`),
  KEY `fk_idmascota_adop` (`idmascota`),
  KEY `fk_idusuario_adop` (`idusuario`),
...
insert  into `adopciones`(`idadopcion`,`idmascota`,`idpersona`,`idusuario`,`fechaadopcion`,`fechadevolucion`,`comentarios`) values 
(3,8,3,1,'2022-04-20 23:47:11',NULL,NULL),
(4,9,2,1,'2022-04-20 23:47:11',NULL,NULL);
...
CREATE TABLE `almacen` (
  ...
  `idusuario` int(11) NOT NULL,
  `fechaalmacen` date DEFAULT current_timestamp(),
  `descripcion` varchar(200) DEFAULT NULL,
  `unidadmedida` varchar(20) NOT NULL,
  PRIMARY KEY (`idalmacen`),
  KEY `fk_idusuario_alm` (`idusuario`),
...
CREATE TABLE `compras` (
  ...
  `fechcompra` datetime NOT NULL DEFAULT cast(current_timestamp() as date),
  `idusuario` int(11) NOT NULL,
  `nota` varchar(250) DEFAULT NULL,
  PRIMARY KEY (`idcompra`),
  KEY `fk_idusuario_comp` (`idusuario`),
  CONSTRAINT `fk_idusuario_comp` FOREIGN KEY (`idusuario`) REFERENCES `usuarios` (`idusuario`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;

/*Data for the table `compras` */

insert  into `compras`(`idcompra`,`fechcompra`,`idusuario`,`nota`) values 
(1,'2022-04-21 00:00:00',1,'Compra realizada por la falta de alimento, pagodo con dinero donado');
...
CREATE TABLE `detcompra` (
  ...
  KEY `fk_idcompra_detc` (`idcompra`),
  CONSTRAINT `fk_idcompra_detc` FOREIGN KEY (`idcompra`) REFERENCES `compras` (`idcompra`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;

/*Data for the table `detcompra` */

insert  into `detcompra`(`iddetallecompra`,`idcompra`,`nombreproducto`,`cantidad`,`preciounidad`) values 
(1,1,'Mimascot 15 kg',2,90.00),
(2,1,'Lejía Clorox 1L',2,5.00),
(3,1,'RicoCat 15kg',1,90.00);

/*Table structure for table `detdonacion` */

DROP TABLE IF EXISTS `detdonacion`;

CREATE TABLE `detdonacion` (
  `iddetdonacion` int(11) NOT NULL AUTO_INCREMENT,
  `iddonacion` int(11) NOT NULL,
  `cantidad` int(11) NOT NULL,
  `descripcion` varchar(500) DEFAULT NULL,
  PRIMARY KEY (`iddetdonacion`),
  KEY `fk_iddonacion_det` (`iddonacion`),
  CONSTRAINT `fk_iddonacion_det` FOREIGN KEY (`iddonacion`) REFERENCES `donaciones` (`iddonacion`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;

/*Data for the table `detdonacion` */

insert  into `detdonacion`(`iddetdonacion`,`iddonacion`,`cantidad`,`descripcion`) values 
(1,1,500,'Dinero en efectivo en Soles Peruanos (S/.)'),
(2,2,2,'Bolsa de alimento para perro de 15kg'),
(3,2,2,'Bolsa de alimento para gatos de 15kg');
...
CREATE TABLE `donaciones` (
  ...
  KEY `fk_idpersona_dona` (`idpersona`),
  KEY `fk_idusuario_dona` (`idusuario`),
...
insert  into `donaciones`(`iddonacion`,`idpersona`,`idusuario`,`tipodonacion`,`fechadonacion`) values 
(1,2,1,'Monetaria','2022-04-20 23:53:39'),
(2,4,1,'Material','2022-04-20 23:53:39');
...
CREATE TABLE `especies` (
  ...
  UNIQUE KEY `uk_especies_esp` (`especie`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;
...
CREATE TABLE `historialmed` (
  ...
  KEY `fk_mascota_his` (`idmascota`),
  KEY `fk_proceso_his` (`idproceso`),
...
/*Data for the table `historialmed` */

/*Table structure for table `historialvol` */

DROP TABLE IF EXISTS `historialvol`;

CREATE TABLE `historialvol` (
  `idhistorial` int(11) NOT NULL AUTO_INCREMENT,
  `idpersona` int(11) NOT NULL,
  `fechainicio` date NOT NULL DEFAULT cast(current_timestamp() as date),
  `fechafin` date DEFAULT NULL,
  `estado` char(1) NOT NULL DEFAULT '1',
  `idrol` int(11) NOT NULL,
  PRIMARY KEY (`idhistorial`),
  KEY `fk_idpersona_hist` (`idpersona`),
  KEY `fk_idrol_hist` (`idrol`),
...
/*Data for the table `historialvol` */

insert  into `historialvol`(`idhistorial`,`idpersona`,`fechainicio`,`fechafin`,`estado`,`idrol`) values 
(1,2,'2022-04-20',NULL,'1',2),
(2,4,'2022-04-20',NULL,'1',1);
...
CREATE TABLE `mascotas` (
  ...
  `fecharescate` date NOT NULL DEFAULT cast(current_timestamp() as date),
  `disponibilidad` char(1) NOT NULL DEFAULT '0',
  `foto` varchar(200) DEFAULT NULL,
  `vive` char(1) NOT NULL DEFAULT 'S',
...
insert  into `mascotas`(`idmascota`,`idraza`,`nombre`,`fecharescate`,`disponibilidad`,`foto`,`vive`,`sexo`) values 
(6,195,'negrito','2022-04-20','0',NULL,'S','M'),
(7,197,'layja','2022-04-20','0',NULL,'S','H'),
(8,95,'fido','2022-04-20','0',NULL,'S','M'),
(9,62,'boby','2022-04-20','0',NULL,'S','M'),
(10,286,'nano','2022-04-20','0',NULL,'S','M');
...
CREATE TABLE `personas` (
  ...
  `nivelconfianza` char(1) NOT NULL DEFAULT '1',
  `iddistrito` varchar(6) NOT NULL,
  `foto` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`idpersona`),
  UNIQUE KEY `uk_nrodoc_per` (`tipodoc`,`nrodoc`),
...
insert  into `personas`(`idpersona`,`nombres`,`apellidos`,`fechanac`,`nrodoc`,`tipodoc`,`telefono`,`correo`,`nivelconfianza`,`iddistrito`,`foto`) values 
(1,'Angel','Crisóstomo Gómez','2001-10-01','70460832','D','922481102','1309013@senati.pe','1','100902',NULL),
(2,'Rosa','Mendoza Apolaya','2000-02-10','70512032','D','98512536','rmendoza@gmail.com','1','110201',NULL),
(3,'Arturo','Quispe Loyola','1999-12-25','98565236','D','956321236','aquipe@gmail.com','1','100803',NULL),
(4,'Giannina','Aranza Lola','1998-12-10','65956362','D','956236596','garanza@gmail.com','1','100803',NULL),
(5,'Gustavo','Mendoza','1998-12-01','95626535','D','956956266','gmendoza@gmail.com','1','110211',NULL),
(6,'Andrea','Solari','2022-03-29','45454515','D','965323232','lsolari@gmail.com','1','110405',NULL),
(7,'Maria','Marcos','2022-04-07','95226236','D','956232626','mmaria@gmailc.om','1','151018',NULL),
(8,'Lorena','Laza','2022-04-01','95623262','N','956263262','llaza@gmail.com','1','190206',NULL),
(9,'Naomi','Mendoza','2022-04-06','69262323','D','956232323','nmendoza@gmai.com','1','110209',NULL);

/*Table structure for table `procesosmedicos` */

DROP TABLE IF EXISTS `procesosmedicos`;

CREATE TABLE `procesosmedicos` (
  `idprocesomedico` int(11) NOT NULL AUTO_INCREMENT,
  `procesomedico` varchar(50) NOT NULL,
  PRIMARY KEY (`idprocesomedico`),
  UNIQUE KEY `uk_proceso_pro` (`procesomedico`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=latin1;

/*Data for the table `procesosmedicos` */

insert  into `procesosmedicos`(`idprocesomedico`,`procesomedico`) values 
(4,'Chequeo Médico'),
(3,'Cirujias'),
(2,'Desparacitación'),
(1,'Vacunación');
...
CREATE TABLE `razas` (
  ...
  PRIMARY KEY (`idraza`),
  UNIQUE KEY `uk_raza_raz` (`idespecie`,`raza`),
...
(7,'American Foxhound',1),
(8,'American pit bull terrier',1),
(9,'American staffordshire terrier',1),
(10,'Ariegeois',1),
(11,'Artois',1),
(12,'Australian silky terrier',1),
(13,'Australian Terrier',1),
(14,'Austrian Black & Tan Hound',1),
(15,'Azawakh',1),
(16,'Balkan Hound',1),
(17,'Basenji',1),
(18,'Basset Alpino (Alpine Dachsbracke)',1),
(19,'Basset Artesiano Normando',1),
(20,'Basset Azul de Gascuña (Basset Bleu de Gascogne)',1),
(21,'Basset de Artois',1),
(22,'Basset de Westphalie',1),
(23,'Basset Hound',1),
(24,'Basset Leonado de Bretaña (Basset fauve de Bretagn',1),
(25,'Bavarian Mountain Scenthound',1),
(26,'Beagle',1),
(27,'Beagle Harrier',1),
(28,'Beauceron',1),
(29,'Bedlington Terrier',1),
(30,'Bichon Boloñes',1),
(31,'Bichón Frisé',1),
(32,'Bichón Habanero',1),
(33,'Billy',1),
(34,'Black and Tan Coonhound',1),
(35,'Bloodhound (Sabueso de San Huberto)',1),
(36,'Bobtail',1),
(37,'Boerboel',1),
(38,'Border Collie',1),
(39,'Border terrier',1),
...
(41,'Bosnian Hound',1),
(42,'Boston terrier',1),
(43,'Bouvier des Flandres',1),
(44,'Boxer',1),
(45,'Boyero de Appenzell',1),
(46,'Boyero de Australia',1),
(47,'Boyero de Entlebuch',1),
(48,'Boyero de las Ardenas',1),
(49,'Boyero de Montaña Bernes',1),
(50,'Braco Alemán de pelo corto',1),
(51,'Braco Alemán de pelo duro',1),
(52,'Braco de Ariege',1),
(53,'Braco de Auvernia',1),
(54,'Braco de Bourbonnais',1),
(55,'Braco de Saint Germain',1),
(56,'Braco Dupuy',1),
(57,'Braco Francés',1),
(58,'Braco Italiano',1),
(59,'Broholmer',1),
(60,'Buhund Noruego',1),
(61,'Bull terrier',1),
(62,'Bulldog americano',1),
(64,'Bulldog francés',1),
(63,'Bulldog inglés',1),
(65,'Bullmastiff',1),
(66,'Ca de Bestiar',1),
(67,'Cairn terrier',1),
(68,'Cane Corso',1),
(69,'Cane da Pastore Maremmano-Abruzzese',1),
(70,'Caniche (Poodle)',1),
(71,'Caniche Toy (Toy Poodle)',1),
(72,'Cao da Serra de Aires',1),
(73,'Cao da Serra de Estrela',1),
(74,'Cao de Castro Laboreiro',1),
(75,'Cao de Fila de Sao Miguel',1),
(76,'Cavalier King Charles Spaniel',1),
(77,'Cesky Fousek',1),
(78,'Cesky Terrier',1),
(79,'Chesapeake Bay Retriever',1),
(80,'Chihuahua',1),
(81,'Chin',1),
(82,'Chow Chow',1),
(83,'Cirneco del Etna',1),
(84,'Clumber Spaniel',1),
(85,'Cocker Spaniel Americano',1),
(86,'Cocker Spaniel Inglés',1),
(87,'Collie Barbudo',1),
(88,'Collie de Pelo Cort',1),
(89,'Collie de Pelo Largo',1),
(90,'Cotón de Tuléar',1),
(91,'Curly Coated Retriever',1),
(92,'Dálmata',1),
(93,'Dandie dinmont terrier',1),
(94,'Deerhound',1),
(95,'Dobermann',1),
(96,'Dogo Argentino',1),
(97,'Dogo de Burdeos',1),
(98,'Dogo del Tibet',1),
(99,'Drentse Partridge Dog',1),
(100,'Drever',1),
(101,'Dunker',1),
(102,'Elkhound Noruego',1),
(103,'Elkhound Sueco',1),
(104,'English Foxhound',1),
(105,'English Springer Spaniel',1),
(106,'English Toy Terrier',1),
(107,'Epagneul Picard',1),
(108,'Eurasier',1),
(109,'Fila Brasileiro',1),
(110,'Finnish Lapphound',1),
(111,'Flat Coated Retriever',1),
(112,'Fox terrier de pelo de alambre',1),
(113,'Fox terrier de pelo liso',1),
(114,'Foxhound Inglés',1),
(115,'Frisian Pointer',1),
(116,'Galgo Español',1),
(117,'Galgo húngaro',1),
(118,'Galgo Italiano',1),
(119,'Galgo Polaco ',1),
(120,'Glen of Imaal Terrier',1),
(121,'Golden Retriever',1),
(122,'Gordon Setter',1),
(123,'Gos dAtura Catalá',1),
(124,'Gran Basset Griffon Vendeano',1),
(125,'Gran Boyero Suizo',1),
(126,'Gran Danés (Dogo Aleman)',1),
(127,'Gran Gascón Saintongeois',1),
(128,'Gran Griffon Vendeano',1),
(129,'Gran Munsterlander',1),
(130,'Gran Perro Japonés',1),
(131,'Grand Anglo Francais Tricoleur',1),
(132,'Grand Bleu de Gascogne',1),
(133,'Greyhound',1),
(134,'Griffon Bleu de Gascogne',1),
(135,'Griffon de pelo duro (Grifón Korthals)',1),
(136,'Griffon leonado de Bretaña',1),
(137,'Griffon Nivernais',1),
(138,'Grifon Belga',1),
(139,'Grifón de Bruselas',1),
(140,'Haldenstoever',1),
(141,'Harrier',1),
(142,'Hokkaido',1),
(143,'Hovawart',1),
(144,'Husky Siberiano (Siberian Husky)',1),
(145,'Ioujnorousskaia Ovtcharka',1),
(146,'Irish Glen of Imaal terrier',1),
(147,'Irish soft coated wheaten terrier',1),
(148,'Irish terrier',1),
(149,'Irish Water Spaniel',1),
(150,'Irish Wolfhound',1),
(151,'Jack Russell terrier',1),
(152,'Jindo Coreano',1),
(153,'Kai',1),
(154,'Keeshond',1),
(155,'Kelpie australiano (Australian kelpie)',1),
(156,'Kerry blue terrier',1),
(157,'King Charles Spaniel',1),
(158,'Kishu',1),
(159,'Komondor',1),
(160,'Kooiker',1),
(161,'Kromfohrländer',1),
(162,'Kuvasz',1),
(163,'Labrador Retriever',1),
(164,'Lagotto Romagnolo',1),
(165,'Laika de Siberia Occidental',1),
(166,'Laika de Siberia Oriental',1),
(167,'Laika Ruso Europeo',1),
(168,'Lakeland terrier',1),
(169,'Landseer',1),
(170,'Lapphund Sueco',1),
(171,'Lebrel Afgano',1),
(172,'Lebrel Arabe (Sloughi)',1),
(173,'Leonberger',1),
(174,'Lhasa Apso',1),
(175,'Lowchen (Pequeño Perro León)',1),
(176,'Lundehund Noruego',1),
(177,'Malamute de Alaska',1),
(178,'Maltés',1),
(179,'Manchester terrier',1),
(180,'Mastiff',1),
(181,'Mastín de los Pirineos',1),
(182,'Mastín Español',1),
(183,'Mastín Napolitano',1),
(357,'Mestizo',1),
(184,'Mudi',1),
(185,'Norfolk terrier',1),
(186,'Norwich terrier',1),
(187,'Nova Scotia duck tolling retriever',1),
(189,'Otterhound',1),
(188,'Ovejero alemán',1),
(190,'Rafeiro do Alentejo',1),
(191,'Ratonero Bodeguero Andaluz',1),
(192,'Retriever de Nueva Escocia',1),
(193,'Rhodesian Ridgeback',1),
(194,'Ridgeback de Tailandia',1),
(195,'Rottweiler',1),
(196,'Saarloos',1),
(197,'Sabueso de Hamilton',1),
(198,'Sabueso de Hannover',1),
(199,'Sabueso de Hygen',1),
(200,'Sabueso de Istria',1),
(201,'Sabueso de Posavaz',1),
(202,'Sabueso de Schiller (Schillerstovare)',1),
(203,'Sabueso de Smaland (Smalandsstovare)',1),
(204,'Sabueso de Transilvania',1),
(205,'Sabueso del Tirol',1),
(206,'Sabueso Español',1),
(207,'Sabueso Estirio de pelo duro',1),
(208,'Sabueso Finlandés',1),
(209,'Sabueso Francés blanco y negro',1),
(210,'Sabueso Francés tricolor',1),
(211,'Sabueso Griego',1),
(212,'Sabueso Polaco (Ogar Polski)',1),
(213,'Sabueso Serbio',1),
(214,'Sabueso Suizo',1),
(215,'Sabueso Yugoslavo de Montaña',1),
(216,'Sabueso Yugoslavo tricolor',1),
(217,'Saluki',1),
(218,'Samoyedo',1),
(219,'San Bernardo',1),
(220,'Sarplaninac',1),
(221,'Schapendoes',1),
(222,'Schipperke',1),
(223,'Schnauzer estándar',1),
(224,'Schnauzer gigante (Riesenschnauzer)',1),
(225,'Schnauzer miniatura (Zwergschnauzer)',1),
(226,'Sealyham terrier',1),
(227,'Segugio Italiano',1),
(228,'Seppala Siberiano',1),
(229,'Setter Inglés',1),
(230,'Setter Irlandés',1),
(231,'Setter Irlandés rojo y blanco',1),
(232,'Shar Pei',1),
(233,'Shiba Inu',1),
(234,'Shih Tzu',1),
(235,'Shikoku',1),
(236,'Skye terrier',1),
(237,'Slovensky Cuvac',1),
(238,'Slovensky Kopov',1),
(239,'Smoushond Holandés',1),
(240,'Spaniel Alemán (German Wachtelhund)',1),
(241,'Spaniel Azul de Picardía',1),
(242,'Spaniel Bretón',1),
(243,'Spaniel de Campo',1),
(244,'Spaniel de Pont Audemer',1),
(245,'Spaniel Francés',1),
(246,'Spaniel Tibetano',1),
(247,'Spinone Italiano',1),
(248,'Spítz Alemán',1),
(249,'Spitz de Norbotten (Norbottenspets)',1),
(250,'Spitz Finlandés',1),
(251,'Spitz Japonés',1),
(252,'Staffordshire bull terrier',1),
(253,'Staffordshire terrier americano',1),
(254,'Sussex Spaniel',1),
(256,'Tchuvatch eslovaco',1),
(255,'Teckel (Dachshund)',1),
(257,'Terranova (Newfoundland)',1),
(258,'Terrier australiano (Australian terrier)',1),
(259,'Terrier brasilero',1),
(260,'Terrier cazador alemán',1),
(261,'Terrier checo (Ceský teriér)',1),
(262,'Terrier galés',1),
(263,'Terrier irlandés (Irish terrier)',1),
(264,'Terrier japonés (Nihon teria)',1),
(265,'Terrier negro ruso',1),
(266,'Terrier tibetano',1),
(267,'Tosa',1),
(268,'Viejo Pastor Inglés',1),
(269,'Viejo Pointer Danés (Old Danish Pointer)',1),
(270,'Vizsla',1),
(271,'Volpino Italiano',1),
(272,'Weimaraner',1),
(274,'Welsh Corgi Cardigan',1),
(275,'Welsh Corgi Pembroke',1),
(273,'Welsh springer spaniel',1),
(276,'Welsh terrier',1),
(277,'West highland white terrier',1),
(278,'Whippet',1),
(279,'Wirehaired solvakian pointer',1),
(280,'Xoloitzcuintle',1),
(281,'Yorkshire Terrier',1),
(350,'abisinio',2),
(324,'american wirehair',2),
(306,'angora turco',2),
(311,'ashera',2),
(355,'australian mist',2),
(352,'azul ruso',2),
(351,'balinés',2),
(286,'bambino',2),
(290,'bengali',2),
(349,'birmano',2),
(317,'bobtail americano',2),
(321,'bobtail japones',2),
(353,'bombay',2),
(312,'britanico pelo largo',2),
(284,'british shorthair',2),
(331,'burmés',2),
(328,'burmilla',2),
(314,'caracat',2),
(295,'ceilán',2),
...
(285,'elfo',2),
(338,'esfinge',2),
(348,'exótico de pelo corto',2),
(289,'gato americano de pelo corto',2),
(299,'german rex',2),
(308,'habana',2),
(316,'highland fold',2),
(291,'himalayo',2),
...
(283,'kohana',2),
(336,'korat',2),
(296,'kurilian bobtail',2),
(327,'laperm',2),
(288,'levkoy ucraniano',2),
(287,'lobo',2),
(294,'maine coon',2),
(292,'manx',2),
(358,'Mestizo',2),
...
(323,'munchkin',2),
(293,'nebelung',2),
(301,'neva masquerade',2),
(344,'ocicat',2),
(346,'oriental pelo corto',2),
(282,'persa',2),
(345,'peterbald',2),
(325,'pixie bob',2),
(310,'ragamuffin',2),
...
(1,'Alimentacion de Animales rescatados'),
(2,'Identificación y rescate de animales vulnerables'),
(3,'Limpieza del refugio animal');
...
CREATE TABLE `usuarios` (
  ...
  UNIQUE KEY `uk_nameuser_usu` (`nombreusuario`),
...
insert  into `usuarios`(`idusuario`,`idpersona`,`nombreusuario`,`passworduser`,`estado`,`fecharegistro`,`fechabaja`) values 
(1,1,'angel2001','$2y$10$6p3vm6t.OZHqlzP1fxSyR.dRn.nFmlUAq/5nsXyzvsgtL3QZHim0W','A','2022-04-20 23:42:04',NULL);

/* Procedure structure for procedure `spu_adopciones_listar` */

/*!50003 DROP PROCEDURE IF EXISTS  `spu_adopciones_listar` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_adopciones_listar`()
BEGIN
...
/* Procedure structure for procedure `spu_cargar_departamentos` */

/*!50003 DROP PROCEDURE IF EXISTS  `spu_cargar_departamentos` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_cargar_departamentos`()
begin 
...
/* Procedure structure for procedure `spu_cargar_distritos` */

/*!50003 DROP PROCEDURE IF EXISTS  `spu_cargar_distritos` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_cargar_distritos`(IN _idprovincia VARCHAR(4))
begin
	select * from distritos where idprovincia = _idprovincia; 
end */$$
DELIMITER ;

/* Procedure structure for procedure `spu_carga_provincias` */

/*!50003 DROP PROCEDURE IF EXISTS  `spu_carga_provincias` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_carga_provincias`(IN _iddepartamento varchar(2))
begin
	select * from provincias where iddepartamento = _iddepartamento;
END */$$
DELIMITER ;

/* Procedure structure for procedure `spu_getActivoOrDesactivos_usuarios` */

/*!50003 DROP PROCEDURE IF EXISTS  `spu_getActivoOrDesactivos_usuarios` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_getActivoOrDesactivos_usuarios`(IN _estado CHAR(1))
BEGIN
...
/* Procedure structure for procedure `spu_getNameuser_usuarios` */

/*!50003 DROP PROCEDURE IF EXISTS  `spu_getNameuser_usuarios` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_getNameuser_usuarios`(IN _nameuser VARCHAR(30))
BEGIN 
...
/* Procedure structure for procedure `spu_histVolunrario_registrar` */

/*!50003 DROP PROCEDURE IF EXISTS  `spu_histVolunrario_registrar` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_histVolunrario_registrar`(
	IN _idpersona INT,
	IN _idrol INT
)
BEGIN 
...
/* Procedure structure for procedure `spu_personas_actualizar` */

/*!50003 DROP PROCEDURE IF EXISTS  `spu_personas_actualizar` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_personas_actualizar`(
...
/* Procedure structure for procedure `spu_personas_getbyID` */

/*!50003 DROP PROCEDURE IF EXISTS  `spu_personas_getbyID` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_personas_getbyID`( IN _idpersona int)
begin
...
/* Procedure structure for procedure `spu_personas_getNumeroDOc` */

/*!50003 DROP PROCEDURE IF EXISTS  `spu_personas_getNumeroDOc` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_personas_getNumeroDOc`(IN _tipodoc CHAR(1), IN _numerodoc CHAR(8))
BEGIN
...
/* Procedure structure for procedure `spu_personas_listarporConfianza` */

/*!50003 DROP PROCEDURE IF EXISTS  `spu_personas_listarporConfianza` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_personas_listarporConfianza`(IN _nivelconfianza CHAR(1))
BEGIN 
	SELECT personas.`nombres`, personas.`apellidos`, personas.`fechanac`,
		personas.`nrodoc`,personas.`tipodoc`,personas.`telefono`,
...
/* Procedure structure for procedure `spu_register_usuarios` */

/*!50003 DROP PROCEDURE IF EXISTS  `spu_register_usuarios` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_register_usuarios`(	IN _idpersona 	INT,
...
/* Procedure structure for procedure `spu_roles_listar` */

/*!50003 DROP PROCEDURE IF EXISTS  `spu_roles_listar` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_roles_listar`()
begin
	select * from roles;
END */$$
DELIMITER ;

/* Procedure structure for procedure `spu_roles_registrar` */

/*!50003 DROP PROCEDURE IF EXISTS  `spu_roles_registrar` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_roles_registrar`(IN _rol VARCHAR(20))
BEGIN 
