...
BEGIN
	INSERT INTO productos (idtipoproducto, idmarca, descripcion, precio)
	VALUES (_idtipoproducto, _idmarca, _descripcion, _precio);
END $$

CALL spu_productos_registrar(2, 4,'Mesa gamer mediano', 290);
CALL spu_productos_listar();
