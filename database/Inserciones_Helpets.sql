...
INSERT INTO razas (raza,idespecie) VALUES 
('Affenpinscher',1),
('Airedale terrier',1),
('Akita',1),
('Akita americano',1),
...
('Austrian Black & Tan Hound',1),
('Azawakh',1),
('Balkan Hound',1),
('Basenji',1),
('Basset Alpino (Alpine Dachsbracke)',1),
('Basset Artesiano Normando',1),
('Basset Azul de Gascuña (Basset Bleu de Gascogne)',1),
('Basset de Artois',1),
('Basset de Westphalie',1),
('Basset Hound',1),
('Basset Leonado de Bretaña (Basset fauve de Bretagne)',1),
...
('Bloodhound (Sabueso de San Huberto)',1),
('Bobtail',1),
('Boerboel',1),
('Border Collie',1),
('Border terrier',1),
...
('Boxer',1),
('Boyero de Appenzell',1),
('Boyero de Australia',1),
('Boyero de Entlebuch',1),
('Boyero de las Ardenas',1),
('Boyero de Montaña Bernes',1),
('Braco Alemán de pelo corto',1),
('Braco Alemán de pelo duro',1),
('Braco de Ariege',1),
('Braco de Auvernia',1),
('Braco de Bourbonnais',1),
('Braco de Saint Germain',1),
('Braco Dupuy',1),
('Braco Francés',1),
('Braco Italiano',1),
('Broholmer',1),
...
('Cairn terrier',1),
('Cane Corso',1),
('Cane da Pastore Maremmano-Abruzzese',1),
('Caniche (Poodle)',1),
('Caniche Toy (Toy Poodle)',1),
('Cao da Serra de Aires',1),
('Cao da Serra de Estrela',1),
('Cao de Castro Laboreiro',1),
...
('Collie Barbudo',1),
('Collie de Pelo Cort',1),
('Collie de Pelo Largo',1),
('Cotón de Tuléar',1),
...
('Fox terrier de pelo de alambre',1),
('Fox terrier de pelo liso',1),
('Foxhound Inglés',1),
('Frisian Pointer',1),
('Galgo Español',1),
('Galgo húngaro',1),
...
('Gordon Setter',1),
('Gos dAtura Catalá',1),
('Gran Basset Griffon Vendeano',1),
('Gran Boyero Suizo',1),
('Gran Danés (Dogo Aleman)',1),
('Gran Gascón Saintongeois',1),
('Gran Griffon Vendeano',1),
('Gran Munsterlander',1),
('Gran Perro Japonés',1),
('Grand Anglo Francais Tricoleur',1),
('Grand Bleu de Gascogne',1),
('Greyhound',1),
('Griffon Bleu de Gascogne',1),
('Griffon de pelo duro (Grifón Korthals)',1),
('Griffon leonado de Bretaña',1),
('Griffon Nivernais',1),
('Grifon Belga',1),
('Grifón de Bruselas',1),
('Haldenstoever',1),
('Harrier',1),
('Hokkaido',1),
('Hovawart',1),
('Husky Siberiano (Siberian Husky)',1),
('Ioujnorousskaia Ovtcharka',1),
('Irish Glen of Imaal terrier',1),
...
('Kai',1),
('Keeshond',1),
('Kelpie australiano (Australian kelpie)',1),
...
('Lagotto Romagnolo',1),
('Laika de Siberia Occidental',1),
('Laika de Siberia Oriental',1),
('Laika Ruso Europeo',1),
('Lakeland terrier',1),
('Landseer',1),
('Lapphund Sueco',1),
('Lebrel Afgano',1),
('Lebrel Arabe (Sloughi)',1),
('Leonberger',1),
('Lhasa Apso',1),
('Lowchen (Pequeño Perro León)',1),
('Lundehund Noruego',1),
('Malamute de Alaska',1),
('Maltés',1),
('Manchester terrier',1),
('Mastiff',1),
('Mastín de los Pirineos',1),
('Mastín Español',1),
('Mastín Napolitano',1),
('Mudi',1),
('Norfolk terrier',1),
...
('Ovejero alemán',1),
('Otterhound',1),
('Rafeiro do Alentejo',1),
('Ratonero Bodeguero Andaluz',1),
('Retriever de Nueva Escocia',1),
('Rhodesian Ridgeback',1),
('Ridgeback de Tailandia',1),
('Rottweiler',1),
('Saarloos',1),
('Sabueso de Hamilton',1),
('Sabueso de Hannover',1),
('Sabueso de Hygen',1),
('Sabueso de Istria',1),
('Sabueso de Posavaz',1),
('Sabueso de Schiller (Schillerstovare)',1),
('Sabueso de Smaland (Smalandsstovare)',1),
('Sabueso de Transilvania',1),
('Sabueso del Tirol',1),
('Sabueso Español',1),
('Sabueso Estirio de pelo duro',1),
('Sabueso Finlandés',1),
('Sabueso Francés blanco y negro',1),
('Sabueso Francés tricolor',1),
('Sabueso Griego',1),
('Sabueso Polaco (Ogar Polski)',1),
('Sabueso Serbio',1),
('Sabueso Suizo',1),
('Sabueso Yugoslavo de Montaña',1),
('Sabueso Yugoslavo tricolor',1),
('Saluki',1),
('Samoyedo',1),
('San Bernardo',1),
('Sarplaninac',1),
('Schapendoes',1),
('Schipperke',1),
('Schnauzer estándar',1),
('Schnauzer gigante (Riesenschnauzer)',1),
('Schnauzer miniatura (Zwergschnauzer)',1),
('Sealyham terrier',1),
('Segugio Italiano',1),
('Seppala Siberiano',1),
('Setter Inglés',1),
('Setter Irlandés',1),
('Setter Irlandés rojo y blanco',1),
('Shar Pei',1),
('Shiba Inu',1),
('Shih Tzu',1),
('Shikoku',1),
...
('Slovensky Cuvac',1),
('Slovensky Kopov',1),
('Smoushond Holandés',1),
('Spaniel Alemán (German Wachtelhund)',1),
('Spaniel Azul de Picardía',1),
('Spaniel Bretón',1),
('Spaniel de Campo',1),
('Spaniel de Pont Audemer',1),
('Spaniel Francés',1),
('Spaniel Tibetano',1),
('Spinone Italiano',1),
('Spítz Alemán',1),
('Spitz de Norbotten (Norbottenspets)',1),
('Spitz Finlandés',1),
('Spitz Japonés',1),
...
('Terranova (Newfoundland)',1),
('Terrier australiano (Australian terrier)',1),
('Terrier brasilero',1),
('Terrier cazador alemán',1),
('Terrier checo (Ceský teriér)',1),
('Terrier galés',1),
('Terrier irlandés (Irish terrier)',1),
('Terrier japonés (Nihon teria)',1),
('Terrier negro ruso',1),
('Terrier tibetano',1),
('Tosa',1),
('Viejo Pastor Inglés',1),
('Viejo Pointer Danés (Old Danish Pointer)',1),
('Vizsla',1),
('Volpino Italiano',1),
('Weimaraner',1),
...
('Whippet',1),
('Wirehaired solvakian pointer',1),
('Xoloitzcuintle',1),
('Yorkshire Terrier',1),
('persa',2),			
('kohana',2),			 	
...
('lobo',2),			 
('levkoy ucraniano',2),		
('gato americano de pelo corto',2),
('bengali',2),
('himalayo',2),
('manx',2),
('nebelung',2),
...
('australian mist',2),
('siamés',2);
SELECT *FROM razas ORDER BY idraza ASC;

INSERT INTO razas(idespecie,raza) VALUES
	(1,"Mestizo"),
	(2,"Mestizo");
...
INSERT INTO  (iddistrito,distrito,idprovincia) VALUES
